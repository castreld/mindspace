...
class BookingService {
  ...
  Future<List<Appointment>> getAppointmentHistory({
    ...
    final url = Uri.parse('$baseUrl/api/appointments/history').replace(queryParameters: queryParams);
  ...
  Future<void> submitReview({
    ...
    final url = Uri.parse('$baseUrl/api/appointments/$appointmentId/reviews');
    final body = json.encode({
      'rating': rating,
  ...
  Future<void> addTherapistNotes({
    ...
    final url = Uri.parse('$baseUrl/api/psikolog/appointments/$appointmentId/notes');
