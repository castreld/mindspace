...
class _FormSectionState extends State<FormSection> {
  ...
  Future<void> _addOrEditTimeSlot(String day, {int? editIndex}) async {
    final Map<String, TimeOfDay>? existingSlot = editIndex != null
        ? _availabilities[day]![editIndex]
        : null;

    final TimeOfDay? startTime = await showTimePicker(
      context: context,
      initialTime:
          existingSlot?['start'] ?? const TimeOfDay(hour: 9, minute: 0),
                        ...
                        trailing: Row(
                          ...
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () => setState(
                                () => _availabilities[day]!.removeAt(idx),
                              ),
                            ),
                          ],
                        ),
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 24),
                const Text(
                  'Spesialisasi (bisa pilih lebih dari satu)',
                  style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500),
                ),
                const SizedBox(height: 8),
